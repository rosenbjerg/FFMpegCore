...
namespace FFMpegCore
{
    public sealed class FFMpegArguments : FFMpegArgumentsBase
    {
        ...
        public static FFMpegArguments FromRawInput(string uri, Action<FFMpegArgumentOptions>? addArguments = null) => new FFMpegArguments().WithInput(new InputArgument(uri, false), addArguments);
